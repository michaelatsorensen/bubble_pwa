...
function showWelcomeCard() {
  ...
  el.innerHTML =
    '<div style="background:rgba(23,15,52,0.82);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:0.5px solid rgba(124,92,252,0.08);border-radius:14px;padding:1rem 1.1rem;position:relative">' +
      ...
      '<div style="display:flex;align-items:center;gap:0.5rem;margin-bottom:0.5rem">' +
        '<div style="width:28px;height:28px;color:rgba(124,92,252,0.8);flex-shrink:0">' + ico('bubble') + '</div>' +
